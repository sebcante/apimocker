...
apiMocker.start = function (port) {
  ...
  if (apiMocker.options.ssl){
    var privateKey  = fs.readFileSync(apiMocker.options.ssl.key, 'utf8');
    var certificate = fs.readFileSync(apiMocker.options.ssl.crt, 'utf8');
    var credentials = {key: privateKey, cert: certificate};
    https.createServer(credentials,  apiMocker.express).listen(apiMocker.options.ssl.port || 443);
  }
